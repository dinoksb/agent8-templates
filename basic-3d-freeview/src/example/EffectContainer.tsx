...
export function EffectContainer() {
  ...
  const handleFireballEffectHit = useCallback((other: IntersectionEnterPayload, pos?: THREE.Vector3, sender?: string) => {
    if (sender) {
        ...
        case EffectType.FIREBALL:
          return (
            <FireBallEffectController
              ...
              onHit={(other, pos) => handleFireballEffectHit(other, pos, effect.sender)}
              onComplete={() => {
